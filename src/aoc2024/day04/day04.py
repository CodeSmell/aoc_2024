...
if __name__ == "__main__":
    ...
    sample_result_part1 = part_one("inputs/day04.sample.txt")
    print(f"Part 1 (sample): {sample_result_part1}")
    
    # Run with actual data
    result_part1 = part_one("inputs/day04.txt")
    print(f"Part 1: {result_part1}")
    
    # Test part 2 with sample data
    sample_result_part2 = part_two("inputs/day04.sample.txt")
    print(f"Part 2 (sample): {sample_result_part2}")
    
    # Run part 2 with actual data
    result_part2 = part_two("inputs/day04.txt")
